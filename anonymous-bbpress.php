...
function anonymous_bbpress_init() {
	...
	anonymous_bbpress_initialize_posting();
}

// initialize anonymous posting
function anonymous_bbpress_initialize_posting() {

	// inject name and email early
...
// inject random name and email into post data
function anonymous_bbpress_set_random_identity( $r ) {

	// access global user array and index
